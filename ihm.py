...
app.Button1 = tk.Button(app)
app.Button1.place(relx=0.011, rely=0.844, height=24, width=67)
app.Button1.configure(activebackground="beige")
app.Button1.configure(activeforeground="#000000")
app.Button1.configure(background="#d9d9d9")
app.Button1.configure(compound='left')
app.Button1.configure(disabledforeground="#a3a3a3")
app.Button1.configure(foreground="#000000")
app.Button1.configure(highlightbackground="#d9d9d9")
app.Button1.configure(highlightcolor="black")
app.Button1.configure(pady="0")
app.Button1.configure(text='''Quitter''')

app.Button2 = tk.Button(app)
app.Button2.place(relx=0.14, rely=0.844, height=24, width=67)
app.Button2.configure(activebackground="beige")
app.Button2.configure(activeforeground="#000000")
app.Button2.configure(background="#d9d9d9")
app.Button2.configure(compound='left')
app.Button2.configure(disabledforeground="#a3a3a3")
app.Button2.configure(foreground="#000000")
app.Button2.configure(highlightbackground="#d9d9d9")
app.Button2.configure(highlightcolor="black")
app.Button2.configure(pady="0")
app.Button2.configure(text='''Valider''')

app.Button2_1 = tk.Button(app)
app.Button2_1.place(relx=0.27, rely=0.844, height=24, width=90)
app.Button2_1.configure(activebackground="beige")
app.Button2_1.configure(activeforeground="#000000")
app.Button2_1.configure(background="#d9d9d9")
app.Button2_1.configure(compound='left')
app.Button2_1.configure(disabledforeground="#a3a3a3")
app.Button2_1.configure(foreground="#000000")
app.Button2_1.configure(highlightbackground="#d9d9d9")
app.Button2_1.configure(highlightcolor="black")
app.Button2_1.configure(pady="0")
app.Button2_1.configure(text='''Exporter en jpg''')
